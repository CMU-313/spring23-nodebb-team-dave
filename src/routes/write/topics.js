...
module.exports = function () {
    ...
    setupApiRoute(router, 'put', '/:tid/close', [...middlewares, middleware.assert.topic], controllers.write.topics.close);
    setupApiRoute(router, 'delete', '/:tid/close', [...middlewares], controllers.write.topics.unclose);
